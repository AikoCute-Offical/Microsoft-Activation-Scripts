...
::  For command line switches, check https://www.facebook.com/hajimecute2001/
...
echo:
echo:
echo:                  Activation Online Menu For Aiko
...
if %_erl%==7 exit /b
if %_erl%==6 start https://www.facebook.com/hajimecute2001 & goto :MainMenu
...
echo Check this page https://www.facebook.com/hajimecute2001/oem-folder
)
...
echo:
echo https://www.facebook.com/hajimecute2001
goto dk_done
)
)
...
if exist "%SystemRoot%\Servicing\Packages\Microsoft-Windows-*EvalEdition~*.mum" (
call :dk_color %Magenta% "Evaluation Windows Found. Install Full version of Windows. https://www.facebook.com/hajimecute2001/"
)
)
...
call :dk_color2 %Magenta% "Check this page for help" %_Yellow% " https://www.facebook.com/hajimecute2001/troubleshoot"
)
)
...
::  5th column = Ticket signature value. It's as it is, it's not encoded. (Check https://www.facebook.com/hajimecute2001/hwid.html#Manual_Activation to see how it's generated)
...
echo https://www.facebook.com/hajimecute2001/kms38.html
goto dk_done
)
)
...
::  Check https://www.facebook.com/hajimecute2001/kms38.html#Manual_Activation to see how it's generated
...
echo Check this page for help https://www.facebook.com/hajimecute2001/troubleshoot
echo Aborting...
goto Done
)
...
if %ActWindows% EQU 0 (
  ...
  if %SSppHook% EQU 0 (
    ...
    echo.&echo Failed checking KMS Activation ID^(s^) for Windows.&echo Check this page for help https://www.facebook.com/hajimecute2001/troubleshoot &call :CheckWS
    exit /b
    )
  )
)
...
call :_color2 %Magenta% "Check this page for help" %_Yellow% " https://www.facebook.com/hajimecute2001/troubleshoot"
exit /b
...
:
: https://www.facebook.com/hajimecute2001/unreadable-codes-in-mas-aio.html
#>
...
if %_erl%==10 start https://www.facebook.com/hajimecute2001/office-license-is-not-genuine &goto at_menu
...
if %_erl%==1 start https://www.facebook.com/hajimecute2001/troubleshoot.html &goto at_menu
goto :at_menu
